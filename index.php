            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <form class="form-inline my-lg-0" id="search" method="POST">
                        <input class="form-control mr-sm-2" name="search-color" type="text" placeholder="Search NCS Color" aria-label="Search">
                        <button class="btn btn-outline-success my-2 my-sm-0" type="submit" id="send">Search</button>
                        <?php include $_SERVER['DOCUMENT_ROOT'] . "/modules/search_color.php"; ?>
                    </form>
